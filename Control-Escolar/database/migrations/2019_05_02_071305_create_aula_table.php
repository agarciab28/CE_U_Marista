...
class CreateAulaTable extends Migration
{
    ...
    public function up()
    {
       ...
       values(user(),'Administrador','ACTUALIZACION',now(),'Aula','ID Aula',old.id, new.id);
       END IF
        ");
       ...
       insert into bitacora(usuario,tipoderol,tipodemov,fecha,tablaafectada, campoalter,valorant,valornuevo)
       values(user(),'Administrador','ACTUALIZACION',now(),'Aula','Aula',old.aula, new.aula);
       END IF
        ");
       ...
       insert into bitacora(usuario,tipoderol,tipodemov,fecha,tablaafectada, campoalter,valorant,valornuevo)
       values(user(),'Administrador','ACTUALIZACION',now(),'Aula','Edificio',old.edificio, new.edificio);
       END IF
        ");
       ...
       insert into bitacora(usuario,tipoderol,tipodemov,fecha,tablaafectada, campoalter,valorant,valornuevo)
       values(user(),'Administrador','ACTUALIZACION',now(),'Aula','Tipo',old.tipo, new.tipo);
       END IF
        ");
       ...
       values (user(),'Administrador',now(),'INSERCION','Aula','No aplica','No aplica','No aplica')
        ");

        DB::unprepared("
        CREATE TRIGGER `deleteaula` BEFORE DELETE ON `aula`
        FOR EACH ROW insert into bitacora(usuario,tipoderol,fecha,tipodemov,tablaafectada,campoalter,valorant,valornuevo)
        values (user(),'Administrador',now(),'ELIMINACION','Aula','Aula',old.aula,'No aplica')
        ");  
    }
