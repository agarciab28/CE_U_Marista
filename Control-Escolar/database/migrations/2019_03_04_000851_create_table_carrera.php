...
class CreateTableCarrera extends Migration
{
    ...
    public function up()
    {
       ...
       values (user(),'Administrador',now(),'INSERCION','Carrera','No aplica','No aplica','No aplica')
        ");
       ...
       values(user(),'Admin','ACTUALIZACION',now(),'Carrera','Fecha',old.fecha, new.fecha);
       END IF
        ");
       ...
       insert into bitacora(usuario,tipoderol,tipodemov,fecha,tablaafectada, campoalter,valorant,valornuevo)
       values(user(),'Admin','ACTUALIZACION',now(),'Nombre Carrera','ID Carrera',old.nombre_carrera, new.nombre_carrera);
       END IF
        ");
       ...
       insert into bitacora(usuario,tipoderol,tipodemov,fecha,tablaafectada, campoalter,valorant,valornuevo)
       values(user(),'Admin','ACTUALIZACION',now(),'Carrera','RVOE',old.rvoe, new.rvoe);
       END IF
        ");
        ...
        FOR EACH ROW insert into bitacora(usuario,tipoderol,fecha,tipodemov,tablaafectada,campoalter,valorant,valornuevo)
       values (user(),'Administrador',now(),'ELIMINACION','Carrera','ID Carrera',old.id_carrera,'No aplica')
        ");
       ...
       insert into bitacora(usuario,tipoderol,tipodemov,fecha,tablaafectada, campoalter,valorant,valornuevo)
       values(user(),'Administrador','ACTUALIZACION',now(),'Carrera','Activo',old.activo, new.activo);
       END IF
       ");
