    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                maxFileSize: 0,
                messages: {
                    "default": "Arrastre y suelte un archivo aquí o haga clic para añadir foto",
                    replace: "Clic para reemplazar foto",
                    remove: "Eliminar",
                    error: "Lo siento, este archivo es demasiado grande"
                },
                tpl: {
