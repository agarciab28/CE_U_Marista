...
<div class="container">
    ...
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large  waves-effect waves-light light-blue darken-4 modal-trigger tooltipped" data-position="left" data-tooltip="Mostrar todos mis datos" href="#modaluser" id="btn_add_aula">
...
<div id="modaluser" class="modal modal-fixed-footer">
  ...
  -->
            ...
            <div class="input-field col s12 m4">
                ...
                <input type="text" name="user" id="user" class="validate" maxlength="35" disabled>
                <label for="user">Usuario</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="password" name="pass" id="pass" class="validate" maxlength="35" disabled>
                <label for="pass">Contraseña</label>
            </div>

            <div class="input-field col m4 s12 ">
                <i class="material-icons prefix">email</i>
                <input type="text" id="correo" class="validate" name="email" maxlength="150" disabled>
                <label for="correo">Correo electrónico</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="nombres" id="nombre" class="validate" maxlength="35" disabled>
                <label for="nombre">Nombre</label>
            </div>
            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" id="apellidop" name="apaterno" class="validate" maxlength="35" disabled>
                <label for="apellidop">Apellido paterno</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" id="apellidom" name="amaterno" class="validate" maxlength="35" disabled>
            ...
            <div class="input-field col m4 s12 ">
                ...
                <input type="text" name="fnaci" class="datepicker" id="fecha1" disabled>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="curp" id="curp" class="validate" maxlength="20" disabled>
                <label for="curp">CURP</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="tel" name="tel" id="tel" class="tel" maxlength="35" disabled>
                <label for="tel">Teléfono</label>
            </div>
            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="tel" name="cel" id="cel" class="cel" maxlength="25" disabled>
                <label for="cel">Celular</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="cedulap" id="cedulap" class="cedula" maxlength="35" disabled>
                <label for="cedulap">Cédula fiscal</label>
            </div>
            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="nssocp" id="nsocp" class="validate" maxlength="25" disabled>
                <label for="nsocp">Número de seguro social</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="estado" id="estado" class="estado" maxlength="25" disabled>
                <label for="estado">Estado</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="ciudad" id="ciudad" class="ciudad" maxlength="25" disabled>
                <label for="ciudad">Ciudad</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="text" name="colonia" id="colonia" class="colonia" maxlength="25" disabled>
                <label for="colonia">Colonia</label>
            </div>

            <div class="input-field col m4 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="number" name="postal" id="postal" class="postal" maxlength="25" disabled>
                <label for="postal">Código postal</label>
            </div>

            <div class="input-field col m2 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="number" name="interior" id="interior" class="interior" maxlength="25" disabled>
                <label for="interior">Número interior</label>
            </div>

            <div class="input-field col m2 s12 ">
                <!--<i class="material-icons prefix">account_circle</i>-->
                <input type="number" name="exterior" id="exterior" class="exterior" maxlength="25" disabled>
