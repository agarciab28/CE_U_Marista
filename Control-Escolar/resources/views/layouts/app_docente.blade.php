  ...
  <body>
    ...
    <ul id="sidenav-1" class="sidenav sidenav-fixed">
      <li>
    	...
    	<li id="home"><a class="white-text" href="{{ route('docente_home') }}" ><i class="fas fa-home white-text" style="margin-right:1.5em; margin-left:0.5em; font-size:1.5em;"></i>Inicio</a></li>

      <ul id="grupos" class="collapsible collapsible-accordion">
        <li>
          <a class="collapsible-header white-text" accordion="false" style="margin-left:2em;"> <i class="material-icons white-text" style="font-size:1.5em;">library_books</i>  Mis grupos <i class="material-icons right white-text" style="margin-right:0;">arrow_drop_down</i></a>
      ...
      <ul id="alumnos" class="collapsible collapsible-accordion">
        <li>
          <a class="collapsible-header white-text" accordion="false" style="margin-left:2em;"> <i class="material-icons white-text" style="font-size:1.5em;">group</i>  Alumnos <i class="material-icons right white-text" style="margin-right:0;">arrow_drop_down</i></a>
          <div class="collapsible-body">
            <ul class="dropdown_menu">
