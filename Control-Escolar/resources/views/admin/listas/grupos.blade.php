  ...
  <table id="example" class="responsive-table striped" style="width:100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> <a onclick="modificar_grupo('{{$grupo->grupo}}')" href="#modal_modificar" class="btn modal-trigger tooltipped" data-position="bottom" data-tooltip="Reasignación de profesor, cambio de carrera o materia"><i class="fas fa-pencil-ruler"></i></a> </td>
