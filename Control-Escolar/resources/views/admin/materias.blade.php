        ...
        <table id="example" class="responsive-table striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="#modal_modificar" class="btn modal-trigger tooltipped" data-position="bottom" data-tooltip="Nombre de la materia, clave, plan de estudios al que corresponde o número de horas de la materia al semestre">Modificar</a> </td>
