...
<body>
  <div class="container" style="width: 18cm">
    <div class="row">
      ...
      <div class="col s12"><div class="head2PDF center">BOLETA DE CALIFICACIONES FINALES</div></div>
    </div>
    <br>
      ...
      <table class="">
        <thead>
          <tr>
              ...
              <th class="tabPDF center">Tipo de evaluación</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="bodyPDF center">1DO EXTRAORDINARIO</td>
          ...
          <tr>
            ...
            <td class="bodyPDF center">1ER EXTRAORDINARIO</td>
